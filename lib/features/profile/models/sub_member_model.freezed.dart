...
class _$SubMemberModelImpl implements _SubMemberModel {
  ...
  @override
  String toString() {
    return 'SubMemberModel(id: $id, fullname: $fullname, firstName: $firstName, lastName: $lastName, membershipNumber: $membershipNumber, memberType: $memberType, birthDate: $birthDate, age: $age)';
  }
