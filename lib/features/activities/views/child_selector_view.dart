          ...
          child: Column(
            ...
            children: [
              ...
              _ChildSelectorCardPremium(
                ...
                delayMs: 100,
                onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ChildDetailProfileView(childName: 'Juanito Pérez'))),
              ),
              ...
              _ChildSelectorCardPremium(
                ...
                delayMs: 250,
                onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ChildDetailProfileView(childName: 'María Pérez'))),
              ),
              ...
              SizedBox(
                ...
                child: TweenAnimationBuilder<double>(
                   ...
                   child: OutlinedButton.icon(
                    onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ActivitiesListView(isSubscribed: false))),
...
class _ChildSelectorCardPremiumState extends State<_ChildSelectorCardPremium> {
  ...
  Widget build(BuildContext context) {
    return TweenAnimationBuilder<double>(
      ...
      builder: (context, value, child) {
         return Opacity(
           opacity: value >= (widget.delayMs / 1000) ? 1.0 : value,
           child: Transform.translate(
             offset: Offset(0, 30 * (1 - value)),
             child: child,
           ),
