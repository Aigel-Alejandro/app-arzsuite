    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._accesoClubes, _accesoClubes) &&
...
abstract class _ActivityModel implements ActivityModel {
  const factory _ActivityModel(
      ...
      final double? monto,
      final List<ActivityGroupModel> grupos}) = _$ActivityModelImpl;
...
abstract class $ActivityGroupModelCopyWith<$Res> {
  factory $ActivityGroupModelCopyWith(
          ActivityGroupModel value, $Res Function(ActivityGroupModel) then) =
...
abstract class _$$ActivityGroupModelImplCopyWith<$Res>
    implements $ActivityGroupModelCopyWith<$Res> {
  factory _$$ActivityGroupModelImplCopyWith(_$ActivityGroupModelImpl value,
...
class __$$ActivityGroupModelImplCopyWithImpl<$Res>
  ...
  __$$ActivityGroupModelImplCopyWithImpl(_$ActivityGroupModelImpl _value,
  ...
  $Res call({
    ...
    return _then(_$ActivityGroupModelImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$ActivityGroupModelImpl implements _ActivityGroupModel {
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$ActivityGroupModelImplToJson(
      this,
    );
  }
}
...
abstract class _ActivityGroupModel implements ActivityGroupModel {
  const factory _ActivityGroupModel(
      ...
      @JsonKey(name: 'requiere_seleccion_lugares')
      final bool requiereSeleccionLugares,
      final List<ActivityTeamModel> equipos}) = _$ActivityGroupModelImpl;
...
abstract class $ActivityTeamModelCopyWith<$Res> {
  factory $ActivityTeamModelCopyWith(
          ActivityTeamModel value, $Res Function(ActivityTeamModel) then) =
...
abstract class _$$ActivityTeamModelImplCopyWith<$Res>
    implements $ActivityTeamModelCopyWith<$Res> {
  factory _$$ActivityTeamModelImplCopyWith(_$ActivityTeamModelImpl value,
...
class __$$ActivityTeamModelImplCopyWithImpl<$Res>
  ...
  __$$ActivityTeamModelImplCopyWithImpl(_$ActivityTeamModelImpl _value,
  ...
  $Res call({
    ...
    return _then(_$ActivityTeamModelImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$ActivityTeamModelImpl implements _ActivityTeamModel {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.color, color) || other.color == color) &&
            const DeepCollectionEquality()
                .equals(other._lugaresOcupados, _lugaresOcupados) &&
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$ActivityTeamModelImplToJson(
      this,
    );
  }
}
...
abstract class _ActivityTeamModel implements ActivityTeamModel {
  const factory _ActivityTeamModel(
      ...
      final List<ActivityScheduleModel> horarios}) = _$ActivityTeamModelImpl;
...
abstract class $ActivityAreaPlanoPositionModelCopyWith<$Res> {
  factory $ActivityAreaPlanoPositionModelCopyWith(
      ...
      _$ActivityAreaPlanoPositionModelCopyWithImpl<$Res,
...
/// @nodoc
class _$ActivityAreaPlanoPositionModelCopyWithImpl<$Res,
...
class __$$ActivityAreaPlanoPositionModelImplCopyWithImpl<$Res>
    extends _$ActivityAreaPlanoPositionModelCopyWithImpl<$Res,
  ...
  $Res call({
    ...
    return _then(_$ActivityAreaPlanoPositionModelImpl(
      filaIndex: null == filaIndex
          ? _value.filaIndex
          : filaIndex // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$ActivityAreaPlanoPositionModelImpl
  ...
  @override
  int get hashCode => Object.hash(
      runtimeType, filaIndex, columnaIndex, etiqueta, tipo, isActive);
  ...
  _$$ActivityAreaPlanoPositionModelImplCopyWith<
          _$ActivityAreaPlanoPositionModelImpl>
      get copyWith => __$$ActivityAreaPlanoPositionModelImplCopyWithImpl<
          _$ActivityAreaPlanoPositionModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ActivityAreaPlanoPositionModelImplToJson(
      this,
    );
  }
}
...
abstract class $ActivityAreaPlanoModelCopyWith<$Res> {
  factory $ActivityAreaPlanoModelCopyWith(ActivityAreaPlanoModel value,
...
/// @nodoc
class _$ActivityAreaPlanoModelCopyWithImpl<$Res,
...
class __$$ActivityAreaPlanoModelImplCopyWithImpl<$Res>
    extends _$ActivityAreaPlanoModelCopyWithImpl<$Res,
  ...
  $Res call({
    ...
    return _then(_$ActivityAreaPlanoModelImpl(
      filas: null == filas
          ? _value.filas
          : filas // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$ActivityAreaPlanoModelImpl implements _ActivityAreaPlanoModel {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._posiciones, _posiciones));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, filas, columnas,
  ...
  _$$ActivityAreaPlanoModelImplCopyWith<_$ActivityAreaPlanoModelImpl>
      get copyWith => __$$ActivityAreaPlanoModelImplCopyWithImpl<
          _$ActivityAreaPlanoModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ActivityAreaPlanoModelImplToJson(
      this,
    );
  }
}
...
abstract class $ActivityScheduleModelCopyWith<$Res> {
  factory $ActivityScheduleModelCopyWith(ActivityScheduleModel value,
...
class __$$ActivityScheduleModelImplCopyWithImpl<$Res>
    extends _$ActivityScheduleModelCopyWithImpl<$Res,
        _$ActivityScheduleModelImpl>
    implements _$$ActivityScheduleModelImplCopyWith<$Res> {
  __$$ActivityScheduleModelImplCopyWithImpl(_$ActivityScheduleModelImpl _value,
  ...
  $Res call({
    ...
    return _then(_$ActivityScheduleModelImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$ActivityScheduleModelImpl implements _ActivityScheduleModel {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._lugaresOcupados, _lugaresOcupados) &&
            const DeepCollectionEquality()
                .equals(other._alumnosInscritos, _alumnosInscritos) &&
  ...
  _$$ActivityScheduleModelImplCopyWith<_$ActivityScheduleModelImpl>
      get copyWith => __$$ActivityScheduleModelImplCopyWithImpl<
          _$ActivityScheduleModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ActivityScheduleModelImplToJson(
      this,
    );
  }
}
