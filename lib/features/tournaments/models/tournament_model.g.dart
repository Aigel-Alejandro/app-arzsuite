...
_$TournamentModelImpl _$$TournamentModelImplFromJson(
    ...
    _$TournamentModelImpl(
      ...
      equiposDisponibles: (json['equipos_disponibles'] as List<dynamic>?)
              ?.map((e) =>
                  TournamentTeamModel.fromJson(e as Map<String, dynamic>))
              .toList() ??
          [],
      sociosInscritos: (json['socios_inscritos'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          [],
      participantes: (json['participantes'] as List<dynamic>?)
              ?.map((e) => TournamentParticipantModel.fromJson(
                  e as Map<String, dynamic>))
              .toList() ??
          [],
      partidos: (json['partidos'] as List<dynamic>?)
              ?.map((e) =>
                  TournamentMatchModel.fromJson(e as Map<String, dynamic>))
              .toList() ??
          [],
...
_$TournamentMatchModelImpl _$$TournamentMatchModelImplFromJson(
    ...
    _$TournamentMatchModelImpl(
      ...
      resultadoAprobadoLocal:
          json['resultado_aprobado_local'] as bool? ?? false,
